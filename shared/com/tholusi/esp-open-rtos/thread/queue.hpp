 ...
 *
 */
template<unsigned portBASE_TYPE uxItemSize>
class queue_buf_t
{
public:
    /**
     ...
     * @return 
     */
    inline int post(const void* data, unsigned long ms = 0)
    {
        return (xQueueSend(queue, data, ms / portTICK_RATE_MS) == pdTRUE) ? 0 : -1;
    }
    /**
     ...
     * @return 
     */
    inline int receive(void* data, unsigned long ms = 0)
    {
     ...
     * @return 
     */
    const queue_buf_t &operator = (const queue_buf_t& other)
    {
