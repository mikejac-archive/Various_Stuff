...
#include <com/atmel/asf-3.20.1/atmega1284p/common/services/ioport/ioport.h>
...
static inline void initSS(ioport_pin_t cs_pin)
{ 
    ioport_set_pin_dir(cs_pin, IOPORT_DIR_OUTPUT);
    ioport_set_pin_level(cs_pin, IOPORT_PIN_LEVEL_HIGH);
    
    //pinMode(wiz_cs_pin, OUTPUT); 
    //digitalWrite(wiz_cs_pin, HIGH); 
}

static inline void setSS(ioport_pin_t cs_pin)     
{ 
    ioport_set_pin_level(cs_pin, IOPORT_PIN_LEVEL_LOW);
    //digitalWrite(wiz_cs_pin, LOW); 
}

static inline void resetSS(ioport_pin_t cs_pin)   
{ 
    ioport_set_pin_level(cs_pin, IOPORT_PIN_LEVEL_HIGH);
    //digitalWrite(wiz_cs_pin, HIGH); 
}
