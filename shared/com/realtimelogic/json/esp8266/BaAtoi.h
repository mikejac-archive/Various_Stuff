...
*/
BA_API U64 ICACHE_FLASH_ATTR U64_atoll(const char* s);
BA_API U64 ICACHE_FLASH_ATTR U64_atoll2(const char* s, const char* e);
...
#define S64_atoll(s) ((S64)U64_atoll(s))
    ...
    */
BA_API U32 ICACHE_FLASH_ATTR U32_negate(U32 n);

   /** Converts characters of s to type U32. The number is negated if
      preceded by '-'. Returns 0 if unable to convert or s is NULL.
    */
BA_API U32 ICACHE_FLASH_ATTR U32_atoi(const char* s);

   /** Works like U32_atoi, but converts from start of string 's' to end 'e'.
    */
BA_API U32 ICACHE_FLASH_ATTR U32_atoi2(const char* s, const char* e);

   /** Converts hex characters of s to type U32. 
       Returns 0 if unable to convert or s is NULL.
    */
BA_API U32 ICACHE_FLASH_ATTR U32_hextoi(const char *s);
#ifdef __cplusplus
}
#endif
